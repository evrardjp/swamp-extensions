...
```
FTL error Error: "Extension @evrardjp/aws/cost-explorer@2026.03.30.1 not found in the registry."
```
...
```bash
git tag --list '@evrardjp/ssh-ca@*' | sort -V | tail -3
```
...
```yaml
version: "2026.07.03.1"  # today's date
```
