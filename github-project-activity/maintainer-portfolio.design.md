...
`@evrardjp/github-project-activity` model instances.
...
work independently on each `@evrardjp/github-project-activity` model. The portfolio
...
```ts
{
  ...
  projects: Array<{
    ...
    modelName: string,
    modelId?: string,
    modelType?: string, // default @evrardjp/github-project-activity
...
5. Whether `@evrardjp/github-project-briefing` should remain single-repo only or be
