...
4. Fetch the refreshed briefing with `swamp report get @evrardjp/maintainer-briefing --model <activity-model> --json` and/or `--markdown`.
...
2. `swamp report get @evrardjp/maintainer-briefing --model <activity-model> --json` returns structured data or a clear missing/stale state.
